...
$content = [
    'strings' => [
        ...
        "inverted_time_chart_title" => get_string("ss_inverted_time_chart_title","local_fliplearning"),
        "inverted_time_chart_x_axis" => get_string("ss_inverted_time_xaxis_title","local_fliplearning"),
        "inverted_time" => get_string("ss_inverted_time_inverted_label","local_fliplearning"),
        "expected_time" => get_string("ss_inverted_time_expected_label","local_fliplearning"),

        "resource_access_title" => get_string("ss_resource_access_chart_title", "local_fliplearning"),
        "resource_access_x_axis" => get_string("ss_resource_access_xaxis_title", "local_fliplearning"),
        "resource_access_y_axis" => get_string("ss_resource_access_yaxis_title", "local_fliplearning"),
        "resource_access_legend1" => get_string("ss_resource_access_legend1", "local_fliplearning"),
        "resource_access_legend2" => get_string("ss_resource_access_legend2", "local_fliplearning"),

        "hours_sessions_title" => get_string("ts_hours_sessions_chart_title", "local_fliplearning"),
        "week_progress_title" => get_string("ss_week_progress_title", "local_fliplearning"),
