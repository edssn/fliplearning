...
$content = [
    'strings' =>[
        "title" => get_string("ss_title", "local_fliplearning"),
        "days" => array(
            get_string("ss_monday", "local_fliplearning"),
            get_string("ss_tuesday", "local_fliplearning"),
            get_string("ss_wednesday", "local_fliplearning"),
            get_string("ss_thursday", "local_fliplearning"),
            get_string("ss_friday", "local_fliplearning"),
            get_string("ss_saturday", "local_fliplearning"),
            get_string("ss_sunday", "local_fliplearning"),
        ),
        "hours" => array(
    ...
    'courseid' => $COURSE->id,
    'userid' => $USER->id,
    'data' => $reports->get_week_sessions(),
